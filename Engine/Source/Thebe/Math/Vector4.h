...
namespace Thebe
{
	...
	THEBE_API Vector4 operator+(const Vector4& leftVector, const Vector4& rightVector);
	THEBE_API Vector4 operator-(const Vector4& leftVector, const Vector4& rightVector);
	THEBE_API Vector4 operator*(const Vector4& vector, double scalar);
	THEBE_API Vector4 operator*(double scalar, const Vector4& vector);
	THEBE_API Vector4 operator/(const Vector4& vector, double scalar);
}