...
namespace Thebe
{
	class THEBE_API RealToRealFunction
	{
	public:
		virtual double Evaluate(double t) const = 0;
	};

	class THEBE_API RealToVector3Function
	{
	public:
		virtual Vector3 Evaluate(double t) const = 0;
	};

	class THEBE_API Vector3ToVector3Function
	{
	public:
	 ...
	 */
	class THEBE_API Quadratic : public RealToRealFunction
	{
	public:
		Quadratic();
	 ...
	 */
	class THEBE_API Cubic : public RealToRealFunction
	{
	public:
		Cubic();
		virtual ~Cubic();
	 ...
	 */
	class THEBE_API QuadraticSpaceCurve : public RealToVector3Function
	{
	public:
		QuadraticSpaceCurve();
	 ...
	 */
	class THEBE_API CubicSpaceCurve : public RealToVector3Function
	{
	public:
		CubicSpaceCurve();
