...
namespace Thebe
{
	...
	THEBE_API Quaternion operator+(const Quaternion& quatA, const Quaternion& quatB);
	THEBE_API Quaternion operator-(const Quaternion& quatA, const Quaternion& quatB);
	THEBE_API Quaternion operator*(const Quaternion& quatA, const Quaternion& quatB);
	THEBE_API Quaternion operator/(const Quaternion& quatA, const Quaternion& quatB);
	THEBE_API Quaternion operator*(const Quaternion& quat, double scalar);
	THEBE_API Quaternion operator*(double scalar, const Quaternion& quat);
	THEBE_API Quaternion operator/(const Quaternion& quat, double scalar);
}