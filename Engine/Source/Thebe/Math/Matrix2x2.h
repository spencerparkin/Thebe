...
namespace Thebe
{
	 ...
	 */
	THEBE_API Matrix2x2 operator+(const Matrix2x2& matrixA, const Matrix2x2& matrixB);
	 ...
	 */
	THEBE_API Matrix2x2 operator*(const Matrix2x2& matrix, double scalar);

	/**
	 * See the documentation for the other variation of this function.
	 */
	THEBE_API Matrix2x2 operator*(double scalar, const Matrix2x2& matrix);
	 ...
	 */
	THEBE_API Vector2 operator*(const Matrix2x2& matrix, const Vector2& vector);
	 ...
	 */
	THEBE_API Vector2 operator*(const Vector2& vector, const Matrix2x2& matrix);
}