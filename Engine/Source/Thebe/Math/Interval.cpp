...
{
	this->A = THEBE_MAX(intervalA.A, intervalB.A);
	this->B = THEBE_MIN(intervalA.B, intervalB.B);
...
{
	this->A = THEBE_MIN(intervalA.A, intervalB.A);
	this->B = THEBE_MAX(intervalA.B, intervalB.B);
}

void Interval::Expand(double value)
{
	this->A = THEBE_MIN(this->A, value);
	this->B = THEBE_MAX(this->B, value);
}
