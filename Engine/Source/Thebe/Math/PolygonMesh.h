...
namespace Thebe
{
	...
	public:
		 ...
		 */
		void ToStandalonePolygonArray(std::vector<Thebe::Polygon>& standalonePolygonArray) const;

		/**
		 * Clear this mesh and then add to it all polygons from the given array.
		 */
		void FromStandalonePolygonArray(const std::vector<Thebe::Polygon>& standalonePolygonArray, double epsilon = 1e-6);
		...
		public:
			 ...
			 */
			void ToStandalonePolygon(Thebe::Polygon& polygon, const PolygonMesh* mesh) const;

			/**
			 * Set this polygon using the given stand-alone polygon and mesh.
			 */
			void FromStandalonePolygon(const Thebe::Polygon& polygon, PolygonMesh* mesh, double epsilon = 1e-6);
