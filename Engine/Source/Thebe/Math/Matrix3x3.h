...
namespace Thebe
{
	...
	public:
		 ...
		 * 
		 * @param[in] anchorAxis This is one of (not an Or-ing of) the THEBE_AXIS_FLAG_* defines, and indicates the anchor-axis used for the orthonormalization process.
	 ...
	 */
	THEBE_API Matrix3x3 operator+(const Matrix3x3& matrixA, const Matrix3x3& matrixB);
	 ...
	 */
	THEBE_API Matrix3x3 operator*(const Matrix3x3& matrix, double scalar);

	/**
	 * See the documentation for the other variation of this function.
	 */
	THEBE_API Matrix3x3 operator*(double scalar, const Matrix3x3& matrix);
	 ...
	 */
	THEBE_API Vector3 operator*(const Matrix3x3& matrix, const Vector3& vector);
	 ...
	 */
	THEBE_API Vector3 operator*(const Vector3& vector, const Matrix3x3& matrix);
}